...
export const heroMarquee = {
  primary: ['REACT', 'TYPESCRIPT', 'NODE.JS', 'MONGODB', 'EXPRESS', 'TAILWIND', 'NEXT.JS', 'SUPABASE'],
  secondary: ['POSTGRESQL', 'GRAPHQL', 'REST APIs', 'FIREBASE', 'VERCEL', 'GIT'],
};
...
export const services = [
  ...
  { icon: 'Database', title: 'Database Design', desc: 'Optimized data schemas' },
  { icon: 'Rocket', title: 'Deployment', desc: 'CI/CD & cloud hosting' },
];

export const techStack = [
  { title: 'Frontend', icon: 'Monitor', items: ['HTML5 & CSS3', 'JavaScript', 'React.js', 'Next.js', 'Sass/SCSS', 'Tailwind CSS', 'TypeScript'] },
  { title: 'Backend', icon: 'Server', items: ['Node.js', 'Express.js', 'REST APIs', 'SQL', 'PostgreSQL', 'GraphQL', 'JWT Auth'] },
  { title: 'Database & Deploy', icon: 'Database', items: ['MongoDB', 'Vercel', 'Netlify', 'Supabase', 'Firebase', 'FireStore'] },
  { title: 'Tools', icon: 'Wrench', items: ['Git & GitHub', 'VS Code', 'Vite', 'ESLint', 'Prettier', 'Linux'] },
];
