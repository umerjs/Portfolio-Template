...
import { personalInfo, aboutBio, aboutTags, stats, services } from '../data/data';
  ...
  return (
    <section id="about" className="py-24 md:py-32 relative overflow-hidden">
      <div className="container mx-auto px-5 sm:px-6 lg:px-8">
        <SectionHeading eyebrow="N°03 / About Me" heading="WHO'S BEHIND THE SCREEN" />

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
          {/* 3D Photo */}
          <motion.div ref={imgRef} style={{ scale: imgScale, rotateY: imgRotate, perspective: 1000 }}>
            <div className="relative group max-w-md mx-auto lg:mx-0">
              {/* Glow behind */}
              <div className="absolute -inset-4 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-2xl"
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <p className="font-mono text-xs text-muted-foreground">Fig. 01 — {personalInfo.name}</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
        ...
        {/* Services - 3D cards */}
        <div>
          <h3 className="font-mono text-sm text-primary mb-10 tracking-widest">WHAT I DO</h3>
